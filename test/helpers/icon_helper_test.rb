...
class IconHelperTest < ActionView::TestCase
  ...
  test "dock icons are a known phosphor set" do
    %w[dots-three clock-counter-clockwise note-pencil arrows-out list-dashes list-numbers share share-network book notebook book-open books caret-left caret-right export download check flower-lotus trash squares-four x paperclip link].each do |name|
