...
class IconHelperTest < ActionView::TestCase
  ...
  test "dock icons are a known phosphor set" do
    %w[dots-three clock-counter-clockwise note-pencil arrows-out list-numbers share share-network book notebook book-open books caret-left caret-right export check flower-lotus x].each do |name|
